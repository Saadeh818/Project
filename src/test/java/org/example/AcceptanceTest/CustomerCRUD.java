...
public class CustomerCRUD {
    ...
    @Given("I click delete customer button")
    ...
    @Given("I enter a different customer information")
    public void iEnterADifferentCustomerInformation() {

    }
    @Given("I click update customer button")
    ...
    public void iEnterCustomerInformation() {
    ...
    @Given("I click add customer button")
