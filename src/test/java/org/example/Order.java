...
public class Order {
    ...
    @Given("I click delete order button")
    ...
    @Given("I click email button")
    public void iClickEmailButton() {
        // Write code here that turns the phrase above into concrete actions
        //throw new io.cucumber.java.PendingException();
    }
    @Given("I confirm sending email")
    ...
    @Given("some order products are not finished")
    ...
    @Given("all order products are finished")
